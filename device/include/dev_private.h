 ...
 *    
 *    This is the private header file containing all the declaration
 *    needed by the device module.
 *
 *
 *    File:       <FILE>
 *    Author:     <AUTHORNAME>
...
#ifndef __DEV_PRIVATE_H
#define __DEV_PRIVATE_H
